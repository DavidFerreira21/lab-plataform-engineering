...
def test_bucket_name_is_consumed_from_env_value(monkeypatch):
    monkeypatch.setattr(main, "S3_BUCKET", "api-storage-us-east-1-123456789012")
    assert main.S3_BUCKET == "api-storage-us-east-1-123456789012"
